export const zh = {
  tab: '插件市场',
  title: '社区插件市场',
  subtitle: '从你选择的来源发现 RunDeep 插件，并按 Harness 运行时分类',
  close: '关闭',
  closeMarket: '关闭插件市场',
  discover: '发现',
  installable: '可安装',
  ...
  manualInstallBody: '以下命令由 RunDeep 根据插件信息生成，可能与仓库中的说明不同。请先检查源码，再复制到 RunDeep 终端执行。',
  installCommand: '安装命令',
  ...
  terminalError: '无法打开 RunDeep 终端，请从应用菜单手动打开后再复制命令。',
  restartError: '无法请求重启 RunDeep，请稍后手动重启。',
  installableBody: '这里显示从当前来源完整目录中初步筛选出的可安装插件。选择插件后，RunDeep 仍会再次验证版本、来源和兼容性。',
  ...
  immutablePlugin: 'RunDeep 核心组件',
  harnessDeepseek: 'DeepSeek 原生 Harness',
  harnessCodex: 'Codex Harness',
  harnessOther: '其他 / 未来 Harness',
  harnessDeepseekEmpty: '未发现 DeepSeek 原生插件。',
  harnessCodexEmpty: '尚未安装 Codex Harness 插件。',
  harnessOtherEmpty: '尚未安装其他 Harness 插件（Claude 将显示在这里）。',
  activePlugin: '已启用',
  ...
  desktopRequiredTitle: '需要 RunDeep 桌面版',
  desktopUnavailable: '安装、卸载、禁用和启用只在 RunDeep 桌面版中可用；你仍然可以浏览插件目录。',
  ...
  confirmInstallBody: '请确认 RunDeep 验证的 npm 包、版本和目标配置。',
  confirmUninstallTitle: '确认卸载插件',
  confirmUninstallBody: '只会卸载当前配置中由插件市场安装并验证过的这个插件。',
  confirmDisableTitle: '确认禁用外部插件',
  confirmDisableBody: 'RunDeep 将停止在当前配置中加载这个插件，但不会卸载对应的 npm 包。',
  confirmEnableTitle: '确认启用插件',
  confirmEnableBody: 'RunDeep 将恢复在当前配置中加载这个插件。对应的代码会在重启后运行。',
  confirmInstall: '确认安装',
  ...
  restartAfterOperation: '操作完成后需要重启 RunDeep，改动才会生效。',
  disableWarning: '禁用不会卸载 npm 包，也不会隔离插件代码。',
  disableRecoveryWarning: '如果插件导致 RunDeep 无法进入此页面，需要按照恢复文档手动处理。',
  ...
  restartRequiredTitle: '需要重启 RunDeep',
  restartRequiredBody: '请重启 RunDeep，让当前配置加载最新的插件状态。',
  restartLater: '稍后重启',
  restartNow: '立即重启',
  restarting: '正在重启...',
  done: '完成',
...
export const en: Record<MarketLocaleKey, string> = {
  ...
  subtitle: 'Discover RunDeep plugins from sources you choose, grouped by Harness runtime',
  close: 'Close',
  ...
  manualInstallBody: 'RunDeep generated this command from the plugin information, so it may differ from the repository instructions. Review the source first, then copy it into RunDeep Terminal.',
  ...
  terminalError: 'RunDeep Terminal could not be opened. Open it from the application menu, then copy the command manually.',
  restartError: 'RunDeep could not be restarted. Restart it manually when convenient.',
  installableBody: 'This view shows plugins pre-screened from the current source’s complete catalog. RunDeep verifies the version, source, and compatibility again after selection.',
  ...
  immutablePlugin: 'RunDeep core component',
  harnessDeepseek: 'Native DeepSeek Harness',
  harnessCodex: 'Codex Harness',
  harnessOther: 'Other / future Harnesses',
  harnessDeepseekEmpty: 'No native DeepSeek plugins found.',
  harnessCodexEmpty: 'No Codex Harness plugins are installed.',
  harnessOtherEmpty: 'No other Harness plugins are installed. Claude will appear here.',
  ...
  desktopRequiredTitle: 'RunDeep Desktop is required',
  desktopUnavailable: 'Install, uninstall, disable, and enable are available only in RunDeep Desktop. You can still browse the catalog.',
  ...
  confirmInstallBody: 'Review the npm package, version, and target profile verified by RunDeep.',
  ...
  confirmDisableBody: 'RunDeep will stop loading this plugin in the active profile without uninstalling its npm package.',
  confirmEnableTitle: 'Confirm plugin enable',
  confirmEnableBody: 'RunDeep will load this plugin in the active profile again. Its code will run after restart.',
  ...
  restartAfterOperation: 'Restart RunDeep after this operation for the change to take effect.',
  disableWarning: 'Disabling does not uninstall the npm package or isolate the plugin’s code.',
  disableRecoveryWarning: 'If the plugin prevents RunDeep from reaching this page, use the manual recovery steps.',
  ...
  restartRequiredTitle: 'Restart RunDeep',
  restartRequiredBody: 'Restart RunDeep so the current profile loads its updated plugin state.',
