...
const INSTALL_REQUIREMENTS_DOCS = {
  en: 'https://github.com/RichGua/Rundeep/blob/main/dsh-community-market/docs/install-and-uninstall.md',
  zh: 'https://github.com/RichGua/Rundeep/blob/main/dsh-community-market/docs/install-and-uninstall.zh.md',
} as const
const CATALOG_ADAPTER_GUIDE_DOCS = {
  en: 'https://github.com/RichGua/Rundeep/blob/main/dsh-community-market/docs/catalog-adapter-guide.md',
  zh: 'https://github.com/RichGua/Rundeep/blob/main/dsh-community-market/docs/catalog-adapter-guide.zh.md',
} as const
const DSH_DESKTOP_ISSUES_URL = 'https://github.com/RichGua/Rundeep/issues'
